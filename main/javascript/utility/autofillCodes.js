            ...
            "function": function (dataContainer, responseId) {
                return new Promise((resolve, reject) => {
                    ...
                    if (requiredFields) {
                        ...
                        if (cityAnswer && cityAnswer.getContent().length > 0 && addressAnswer && addressAnswer.getContent().length > 0) {
                            //Combine address and city with "Canada" to form a Geocodable address
                            addressFormattedQuery = addressAnswer.getContent() + " " + cityAnswer.getContent() + ", Canada";
